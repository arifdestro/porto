                ...
                @if(!empty($settings['hero_image']))
                    <div class="hero-image-wrapper">
                        <div class="hero-image-frame">
                            <img src="{{ asset($settings['hero_image']) }}" alt="Hero" class="hero-image">
                        </div>
                        ...
                        <div class="portfolio-card-image">
                            ...
                            <div class="portfolio-overlay">
                                <div class="portfolio-overlay-content">
                                    @if($portfolio->link)
                                        <a href="{{ $portfolio->link }}" class="portfolio-view-btn" target="_blank">
...
<section class="section-padding bg-light-custom position-relative" id="contact">
    ...
    <div class="container position-relative" style="z-index: 1;">
        <div class="row text-center text-md-start mb-5" data-aos="fade-up">
            <div class="col-12">
                <span class="section-badge">
                    ...
                    <form action="#" method="POST" class="contact-form">
                        <div class="row g-3">
                            <div class="col-md-6">
                                ...
                                <input type="text" class="form-control form-control-lg bg-light-custom border-0 custom-input" placeholder="John Doe" required>
                            </div>
                            <div class="col-md-6">
                                <label class="form-label fw-semibold" style="font-size: 0.9rem;">Email Address</label>
                                <input type="email" class="form-control form-control-lg bg-light-custom border-0 custom-input" placeholder="john@example.com" required>
                            </div>
                            <div class="col-12 mt-4">
                                <label class="form-label fw-semibold" style="font-size: 0.9rem;">Subject</label>
                                <input type="text" class="form-control form-control-lg bg-light-custom border-0 custom-input" placeholder="Project Inquiry" required>
                            </div>
                            <div class="col-12 mt-4">
                                <label class="form-label fw-semibold" style="font-size: 0.9rem;">Message</label>
                                <textarea class="form-control form-control-lg bg-light-custom border-0 custom-input" rows="4" placeholder="Tell me about your project..." required></textarea>
                            </div>
                            <div class="col-12 mt-4">
                                <button type="button" class="btn btn-primary-custom w-100 py-3 d-flex align-items-center justify-content-center gap-2" onclick="alert('This is a demo form. For real inquiries, please use the email address provided.')">
