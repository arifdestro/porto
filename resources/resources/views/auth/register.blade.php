...
[data-theme="dark"] .auth-form .form-control:focus { background: #0F172A; }
...
[data-theme="dark"] .auth-footer { background: #020617; }
...
.auth-footer .footer-social a:hover { color: var(--primary); }
</style>
@endpush
