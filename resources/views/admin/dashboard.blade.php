...
<h4 class="mb-3 mt-2"><i class="bi bi-graph-up-arrow me-2 text-primary"></i>Visitor Analytics</h4>
<div class="row g-4 mb-4">
    <div class="col-sm-6 col-xl-3">
        <div class="stat-card">
            <div class="stat-card-body">
    ...
    <div class="col-sm-6 col-xl-3">
        <div class="stat-card">
            ...
            <a href="{{ route('admin.posts.index') }}" class="stat-card-footer">
