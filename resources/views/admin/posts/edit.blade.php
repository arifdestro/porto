            ...
            <div class="row">
                <div class="col-md-8">
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="category" class="form-control @error('category') is-invalid @enderror" value="{{ old('category', $post->category) }}" placeholder="e.g. Tutorial, Tips, Review">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="content" id="summernote" class="form-control @error('content') is-invalid @enderror" required>{{ old('content', $post->content) }}</textarea>
                ...
                <div class="col-md-4">
                    <div class="admin-card mb-3 bg-body-tertiary">
                        <div class="admin-card-body">
                            ...
                            <div class="form-check form-switch mt-3">
                                <input class="form-check-input" type="checkbox" role="switch" name="is_published" id="is_published" value="1" {{ old('is_published', $post->is_published) ? 'checked' : '' }}>
                        ...
                        <div class="admin-card-body">
                            ...
                            @if($post->image)
                                <div class="mb-3">
                                    ...
                                    <img src="{{ asset($post->image) }}" class="img-fluid rounded" alt="Current cover">
                                </div>
                            @endif
                            
                            <div class="mb-3">
                                <label class="d-block mb-2">Upload New Image (Optional)</label>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="excerpt" class="form-control @error('excerpt') is-invalid @enderror" rows="4">{{ old('excerpt', $post->excerpt) }}</textarea>
            ...
            callbacks: {
                onInit: function() {
                    function applyDarkToEditor() {
                        ...
                        if (isDark) {
                            $editable.css({ 'background-color': '#1a202c', 'color': '#e2e8f0' });
                        } else {
                            $editable.css({ 'background-color': '', 'color': '' });
                        }
                    }
                    applyDarkToEditor();
